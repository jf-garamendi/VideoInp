...
import argparse
import torch
from loaders.flow_dataloader import *
...
def ReadArguments():
    ...
    parser.add_argument('--flow_dir', type=str, help='Dir where the flow files are (default: %(default)s)', default='./flow_dir')
    parser.add_argument('--mask_dir', type=str, help='Dir where the mask files are (default: %(default)s)',
                        default='./mask_dir')
