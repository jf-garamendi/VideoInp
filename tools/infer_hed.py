...
#root="/home/pierrick/Documents/GitHub/data/DAVIS-2017-trainval-480p/DAVIS/JPEGImages/480p"
#new_root="/home/pierrick/Documents/GitHub/data/DAVIS-2017-trainval-480p/DAVIS/Boundaries"
    # root="/home/pierrick/Documents/GitHub/data/Youtube_VOS_2018/train/JPEGImages"
    # new_root="/home/pierrick/Documents/GitHub/data/Youtube_VOS_2018/train/HED"
...
if __name__ == '__main__':
    ...
    root="/home/pierrick/Documents/GitHub/data/DAVIS-2017-trainval-480p/DAVIS/JPEGImages/480p"
    new_root="/home/pierrick/Documents/GitHub/data/DAVIS-2017-trainval-480p/DAVIS/HED"
            ...
            for f in os.listdir(os.path.join(root,dir)):
                if os.path.isfile(os.path.join(root,dir,f)):
                    if '.jpg' in f:
                        ...
                        arguments_strIn=os.path.join(root,dir,f)
                        arguments_strOut=os.path.join(new_root,dir,f)
